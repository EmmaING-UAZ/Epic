...
`;
  ...
  const galleryData1 = [
    ...
    const galleryData2 = [
      {
        src: "./images/fit/images/4.1.jpg",
        title: "Gimnasio",
        price: "Desde $1,800",
        description:
          "Dar click en la imagen para ver el contenido completo de la página o descarga la imagen para compartir.",
        download: "./images/fit/images/4.1.jpg",
      },
      {
        src: "./images/fit/images/4.2.jpg",
        title: "Gimnasio",
        price: "Desde $1,800",
        description:
          "Dar click en la imagen para ver el contenido completo de la página o descarga la imagen para compartir.",
        download: "./images/fit/images/4.2.jpg",
      },
      {
        src: "./images/fit/images/4.3.jpg",
        title: "Gimnasio",
        price: "Desde $1,800",
        description:
          "Dar click en la imagen para ver el contenido completo de la página o descarga la imagen para compartir.",
        download: "./images/fit/images/4.3.jpg",
      },
