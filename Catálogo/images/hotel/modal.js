...
`;
  ...
  const galleryData1 = [
    {
      src: "./images/hotel/images/1.1.jpg",
      title: "Resort",
      price: "Desde $1,500",
      description:
        "Dar click en la imagen para ver el contenido completo de la página o descarga la imagen para compartir.",
      download: "./images/hotel/images/1.1.jpg",
    },
    {
      src: "./images/hotel/images/1.2.jpg",
      title: "Resort",
      price: "Desde $1,800",
      description:
        "Dar click en la imagen para ver el contenido completo de la página o descarga la imagen para compartir.",
      download: "./images/hotel/images/4.2.jpg",
    },
    {
      src: "./images/hotel/images/1.3.jpg",
      title: "Resort",
      price: "Desde $1,800",
      description:
        "Dar click en la imagen para ver el contenido completo de la página o descarga la imagen para compartir.",
      download: "./images/hotel/images/4.3.jpg",
    },
  ];
    ...
    const galleryData2 = [
      {
        src: "./images/hotel/images/2.1.jpg",
        title: "Hotel",
        price: "Desde $1,800",
        description:
          "Dar click en la imagen para ver el contenido completo de la página o descarga la imagen para compartir.",
        download: "./images/hotel/images/4.1.jpg",
      },
      {
        src: "./images/hotel/images/2.2.jpg",
        title: "Hotel",
        price: "Desde $1,800",
        description:
          "Dar click en la imagen para ver el contenido completo de la página o descarga la imagen para compartir.",
      ...
      {
        src: "./images/hotel/images/2.3.jpg",
        title: "Hotel",
        price: "Desde $1,800",
        description:
          "Dar click en la imagen para ver el contenido completo de la página o descarga la imagen para compartir.",
