...
modalContent.style.cssText = `
  ...
  width: 100%;
  max-width: 800px; /* Ajustado para un máximo más pequeño */
...
`;
    ...
    imageContainer.style.cssText = `
      position: relative;
      width: 100%;
      max-width: 100%; /* Ajuste para que no se recorte */
      height: 250px; /* Se redujo ligeramente la altura */
      margin-top: 40px;
      margin-bottom: 20px;
      overflow: hidden;
    `;
    ...
    function addDownloadButton(infoContainer, galleryData, currentImageIndex) {
      ...
      downloadBtn.addEventListener("click", function(e) {
        ...
        link.download = currentData.title + ".png";
    ...
    function updateGalleryContent() {
      ...
      downloadBtn.download = currentData.title + ".png";
  ...
  const galleryData1 = [
    {
      src: "./images/restaurantes/imagenes/2.png",
      title: "Restaurant de desayunos",
      price: "Desde $1,500",
      description: "Dar click en la imagen para ver el contenido completo de la página o descarga la imagen para compartir.",
      download: "./images/restaurantes/imagenes/2.png" 
    },
  ];

  const galleryData2 = [
    {
      src: "./images/restaurantes/imagenes/16.1.png",
    ...
    {
      src: "./images/restaurantes/imagenes/16.2.png",
      title: "Tienda de pasteles",
      price: "Desde $1,800",
      description: "Dar click en la imagen para ver el contenido completo de la página o descarga la imagen para compartir.",
      download: "./images/restaurantes/imagenes/2.png" 
    ...
    {
      src: "./images/restaurantes/imagenes/16.3.png",
      title: "Tienda de pasteles",
      price: "Desde $1,800",
      description: "Dar click en la imagen para ver el contenido completo de la página o descarga la imagen para compartir.",
      download: "./images/restaurantes/imagenes/2.png" 
  ...
  const allGalleryData = [
    galleryData1,
    galleryData2,
    // ... Add the rest of your gallery data arrays here (galleryData2 through galleryData25)
  ];
