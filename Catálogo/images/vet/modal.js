...
`;
  ...
  if (window.innerWidth < 768) {
    ...
    const galleryData1 = [
      {
        src: "./images/vet/images/1.1.jpg",
        title: "Veterinaria",
        price: "Desde $1,800",
        description:
          "Dar click en la imagen para ver el contenido completo de la página o descarga la imagen para compartir.",
        download: "./images/vet/images/1.1.jpg",
      },

      {
        src: "./images/vet/images/1.2.jpg",
        title: "Veterinaria",
        price: "Desde $1,800",
        description:
          "Dar click en la imagen para ver el contenido completo de la página o descarga la imagen para compartir.",
        download: "./images/vet/images/1.2.jpg",
      },

      {
        src: "./images/vet/images/1.3.jpg",
        title: "Veterinaria",
        price: "Desde $1,800",
        description:
          "Dar click en la imagen para ver el contenido completo de la página o descarga la imagen para compartir.",
        download: "./images/vet/images/1.3.jpg",
      },
    ];
  
    const galleryData2 = [
      {
        src: "./images/vet/images/2.1.jpg",
        title: "Veterinaria",
        price: "Desde $1,800",
        description:
          "Dar click en la imagen para ver el contenido completo de la página o descarga la imagen para compartir.",
        download: "./images/vet/images/2.1.jpg",
      },
      {
        src: "./images/vet/images/2.2.jpg",
        title: "Veterinaria",
        price: "Desde $1,800",
        description:
          "Dar click en la imagen para ver el contenido completo de la página o descarga la imagen para compartir.",
        download: "./images/vet/images/2.2.jpg",
      },
      {
        src: "./images/vet/images/2.3.jpg",
        title: "Veterinaria",
        price: "Desde $1,800",
        description:
          "Dar click en la imagen para ver el contenido completo de la página o descarga la imagen para compartir.",
        download: "./images/vet/images/2.3.jpg",
      },
      
    ];


    const allGalleryData = [galleryData1, galleryData2];
